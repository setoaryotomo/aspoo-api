...
from modified_pso_algorithm_v1 import (
    Item, CustomerPreference, RecommendationResult,
    CustomerRecommendationPSO, load_items_from_excel, create_customer_preference
)
...
class RecommendationService:
    ...
    def __init__(self, excel_file_path: str = "product_data.xlsx"):
    ...
    def load_data(self):
        ...
        try:
            ...
            self.items = load_items_from_excel(self.excel_file_path)
...
def recommend_products():
    ...
    Expected JSON payload:
    {
        "budget": 100000,
        "weight_capacity": 500,
        "preferred_categories": ["Abon", "Kripik"],  // optional
...
if __name__ == '__main__':
    ...
    # Run Flask app
    logger.info("Starting PSO Product Recommendation API...")
    app.run(
        host='127.0.0.1',
        port=5001,
